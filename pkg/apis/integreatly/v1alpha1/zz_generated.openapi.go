...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"github.com/redhat-integration/rhi-operator/pkg/apis/integreatly/v1alpha1.RHMI":       schema_pkg_apis_integreatly_v1alpha1_RHMI(ref),
		"github.com/redhat-integration/rhi-operator/pkg/apis/integreatly/v1alpha1.RHMISpec":   schema_pkg_apis_integreatly_v1alpha1_RHMISpec(ref),
		"github.com/redhat-integration/rhi-operator/pkg/apis/integreatly/v1alpha1.RHMIStatus": schema_pkg_apis_integreatly_v1alpha1_RHMIStatus(ref),
	}
}
...
func schema_pkg_apis_integreatly_v1alpha1_RHMI(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("github.com/redhat-integration/rhi-operator/pkg/apis/integreatly/v1alpha1.RHMISpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("github.com/redhat-integration/rhi-operator/pkg/apis/integreatly/v1alpha1.RHMIStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/redhat-integration/rhi-operator/pkg/apis/integreatly/v1alpha1.RHMISpec", "github.com/redhat-integration/rhi-operator/pkg/apis/integreatly/v1alpha1.RHMIStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}
...
func schema_pkg_apis_integreatly_v1alpha1_RHMISpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"pullSecret": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("github.com/redhat-integration/rhi-operator/pkg/apis/integreatly/v1alpha1.PullSecretSpec"),
						},
					},
					"useClusterStorage": {
						SchemaProps: spec.SchemaProps{
		...
		Dependencies: []string{
			"github.com/redhat-integration/rhi-operator/pkg/apis/integreatly/v1alpha1.PullSecretSpec"},
	}
}
...
func schema_pkg_apis_integreatly_v1alpha1_RHMIStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
					...
					"stages": {
						SchemaProps: spec.SchemaProps{
							...
							AdditionalProperties: &spec.SchemaOrBool{
								...
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("github.com/redhat-integration/rhi-operator/pkg/apis/integreatly/v1alpha1.RHMIStageStatus"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/redhat-integration/rhi-operator/pkg/apis/integreatly/v1alpha1.RHMIStageStatus"},
	}
}
